...
class ExerciseActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    private fun customDialogForBackButton() {
        ...
        val dialogBinding = DialogCustomBackConfirmationBinding.inflate(
            layoutInflater
        )
    ...
    private fun setupRestView() {
        ...
        val nextExercise = exerciseList!![curExercisePosition + 1].getName()
        binding?.tvTitle?.text = "Get Ready for $nextExercise"
    ...
    private fun setupExerciseView() {
        ...
        val exerciseName = exerciseList!![curExercisePosition].getName()
        binding?.ivImage?.setImageResource(
            exerciseList!![curExercisePosition].getImage()
        )
    ...
    private fun setRestProgressBar() {
        ...
        restTimer = object : CountDownTimer(
            ...
            override fun onFinish() {
                ...
                exerciseAdapter!!.notifyItemChanged(curExercisePosition)
                setupExerciseView()
                Toast.makeText(
